...
- XML sitemap: run `"$HOME/.claude/skills/seo/bin/claude-seo" run sitemap_discovery.py <url> --json`; require a
...
"$HOME/.claude/skills/seo/bin/claude-seo" run agent_ux_check.py https://example.com --json
```
...
`"$HOME/.claude/skills/seo/bin/claude-seo" run render_page.py <url> --a11y-tree --json`.
